...
# Connecting to DB
client = MongoClient(f"mongodb+srv://{MONGO_USER}:{MONGO_PASS}@adslab.jtazlad.mongodb.net/test", server_api=ServerApi('1'))
...
usr_name = Label(window ,text = f"Connected to Cloud MongoDB as: Sanket", background = "white").grid(row = 0, column = 1, pady=20)
